...
public class Data {
	...
	public static HashMap<Integer,ArrayList<Entity>> models;
	public static HashMap<Integer,Color> brickColorMap;
	
	public static void setup()
	{
		units = new HashMap<Integer,Unit>();
		units.put(0,new Unit(0,5,10,6,40,8D/40D,70,70,"Warband",0));
		units.put(1,new Unit(1,15,15,10,40,8D/40D,30,20,"Warlord",0));
		units.put(2,new Unit(2,10,8,6,30,14D/40D,70,50,"Raider",1));
		units.put(3,new Unit(3,10,25,5,6,7D/40D,100,50,"War Elephant",2));
		units.put(4,new Unit(4,19,15,10,30,12D/40D,50,25,"Noble Cavalry",2));
		units.put(5,new Unit(5,4,4,4,121,12D/40D,80,80,"Peasants",0));
		
		models = new HashMap<Integer,ArrayList<Entity>>();
	...
	public static void addModel(int id, ArrayList<Entity> model)
	{
		models.put(id, model);
	}
